...
public abstract class DelegatedChunkGenerator extends ChunkGenerator {
    ...
    public DelegatedChunkGenerator(BiomeSource biomeSource, ChunkGenerator delegate) {
        super(biomeSource);
    ...
    public ChunkGeneratorStructureState createState(HolderLookup<StructureSet> holderLookup, RandomState randomState, long seed) {
        return delegate.createState(holderLookup, randomState, seed);
    }
    ...
    @Nullable
    @Override
    public Pair<BlockPos, Holder<Structure>> findNearestMapStructure(ServerLevel serverLevel, HolderSet<Structure> holderSet, BlockPos blockPos, int radius, boolean skipKnownStructures) {
        return delegate.findNearestMapStructure(serverLevel, holderSet, blockPos, radius, skipKnownStructures);
    }
